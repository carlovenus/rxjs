let BehaviorSubject,ReplaySubject,AsyncSubject;_1fc‍.w("rxjs",[["BehaviorSubject",["BehaviorSubject"],function(v){BehaviorSubject=v}],["ReplaySubject",["ReplaySubject"],function(v){ReplaySubject=v}],["AsyncSubject",["AsyncSubject"],function(v){AsyncSubject=v}]]);// A subject is an observable that can multicast i.e. talk to many observers.
